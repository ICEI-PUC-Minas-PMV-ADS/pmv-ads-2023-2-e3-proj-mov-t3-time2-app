module.exports = {
    ...
    async queryPostUser(context) {
        let query = `INSERT INTO taskbook.user(nome,email,senha,idade,cargo)`
        query += ` VALUES ('${context.nome}', '${context.email}','${context.senha}', '${context.idade}','${context.cargo}')`
        return query
    },
